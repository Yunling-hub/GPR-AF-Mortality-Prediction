...
target = 'death_within_icu_30days'
...
results_df.to_csv("./results/All_models_results_30days.csv", index=False)
print(f"\nResults saved.")
...
optimal_eval.to_csv("./results/Optimal_model_evaluation_30days.csv", index=False)
...
forest_df[['Model', 'AUC_CI']].to_csv("./results/AUC_with_CI_30days.csv", index=False)
...
}]).to_csv("./results/DCA_optimal_threshold_30days.csv", index=False)
